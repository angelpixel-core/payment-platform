...
func (e *Engine) Resolve(headerScenario, paymentMethodToken string) (domain.ScenarioName, error) {
...
func (e *Engine) Outcome(name domain.ScenarioName) (domain.ScenarioOutcome, error) {
