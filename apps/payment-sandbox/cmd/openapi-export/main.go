...
func main() {
	in := flag.String("in", "./docs/openapi/v1/payment-sandbox.v1.yaml", "input OpenAPI YAML path")
	out := flag.String("out", "./docs/openapi/v1/payment-sandbox.v1.json", "output OpenAPI JSON path")
	flag.Parse()
