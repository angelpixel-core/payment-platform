...
- [x] `refactor(payment-sandbox): harden hexagonal boundaries`
...
- [x] `refactor(payment-sandbox): introduce read models and projections`
  ...
  - [x] Mantener la side write aislada de optimizaciones de lectura. [Evidence](../../../../../apps/payment-sandbox/internal/application/queries/boundaries_test.go)
